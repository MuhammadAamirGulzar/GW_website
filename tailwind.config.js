    ...
    extend: {
      colors: {
        ...
        gradient: {
          ...
          accent: 'linear-gradient(135deg, #e066ff 0%, #a831c7 100%)',
          sunset: 'linear-gradient(135deg, #f59e0b 0%, #dc2626 100%)',
          ocean: 'linear-gradient(135deg, #0ea5e9 0%, #22c55e 100%)',
          cosmic: 'linear-gradient(135deg, #a831c7 0%, #0284c7 100%)',
        }
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        'hard': '0 10px 40px -4px rgba(0, 0, 0, 0.15), 0 4px 25px -5px rgba(0, 0, 0, 0.1)',
